...
curl -o $PWD/paper.jar https://papermc.io/api/v1/paper/1.16.1/114/download
curl -o $PWD/plugins/fastasynworldedit.jar https://ci.athion.net/job/FastAsyncWorldEdit-1.16/lastSuccessfulBuild/artifact/worldedit-bukkit/build/libs/FastAsyncWorldEdit-1.16-306.jar
