...
curl -o $PWD/paper.jar https://papermc.io/api/v1/paper/1.16.1/79/download
curl -o $PWD/plugins/fastasynworldedit.jar https://ci.athion.net/job/FastAsyncWorldEdit-1.16/lastSuccessfulBuild/artifact/worldedit-bukkit/build/libs/FastAsyncWorldEdit-1.16-293.jar
